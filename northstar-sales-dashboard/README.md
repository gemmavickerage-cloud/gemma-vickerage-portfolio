...
The dashboard brings together sales, returns, product, store and date data to answer key business questions and make trends and areas requiring attention easier to identify.

### Key Areas of Analysis

- **Sales Performance** – Analyse sales performance across regions, products and time.
- **Returns Analysis** – Track return rates and understand the reasons behind returned products.
- **Regional Performance** – Compare performance across different regions and identify geographical trends.
- **Product Analysis** – Identify products with the highest return rates and investigate common return reasons.
...
- Interactive filter panel using Power BI bookmarks
- Dynamic charts and KPI cards
- Top 10 analysis using return rate
